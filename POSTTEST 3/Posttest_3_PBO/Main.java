...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ArrayList<Pasien> dtPasien = new ArrayList<>();
        ArrayList<Perawat> dtPerawat = new ArrayList<>();
        ArrayList<Dokter> dtDokter = new ArrayList<>();
        while (true) {
            System.out.println("=============================");
                    ...
                    switch (readData) {
                        ...
                        case 3:
                            ...
                            for (int i = 0; i < dtDokter.size(); i += 1) {
                                ...
                                System.out.println("Nama Dokter      : " + dtDokter.get(i).getNama());
                                System.out.println("Umur Dokter      : " + dtDokter.get(i).getUmur());
                                System.out.println("ID Dokter        : " + dtDokter.get(i).getId_dokter());
                                System.out.println("=============================");
                            }
                            System.out.print("Press [enter] to continue...");
                            new java.util.Scanner(System.in).nextLine();
